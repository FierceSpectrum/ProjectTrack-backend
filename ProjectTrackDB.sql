...
CREATE TABLE IF NOT EXISTS task_assignments(
    ...
    CONSTRAINT task_assignments_task_id_fkey FOREIGN key(task_id) REFERENCES tasks(id),
    CONSTRAINT task_assignments_assignment_id_fkey FOREIGN key(assignment_id) REFERENCES assignments(id)
);
...
CREATE TABLE IF NOT EXISTS task_participants(
    ...
    CONSTRAINT task_participants_task_id_fkey FOREIGN key(task_id) REFERENCES tasks(id),
    CONSTRAINT task_participants_participant_id_fkey FOREIGN key(participant_id) REFERENCES participants(id)
);
...
insert into members (organization_id, user_id, state_member, "createdAt", "updatedAt") VALUES
(1, 2, 'Create', now(), now()),
(2, 3, 'Create', now(), now()),
(3, 3, 'Create', now(), now()),
(4, 2, 'Create', now(), now()),
...
insert into tasks (project_id, state_id, name, description, start_date, end_date, state_task, "createdAt", "updatedAt") VALUES
(1, 1, 'Web', 'Realizar una pagina web', now(), now(), 'Create', now(), now()),
(1, 1, 'Api Rest', 'Realizar una Api Rest', now(), now(), 'Create', now(), now()),
(2, 7, 'Data Base', 'Realizar la base de datos', now(), now(), 'Create', now(), now()),
(3, 4, 'Curso', 'Realizar una curso de html', now(), now(), 'Create', now(), now());
...
insert into task_assignments (task_id, assignment_id, "createdAt", "updatedAt") VALUES
(1, 1, now(), now()),
(2, 2, now(), now()),
(3, 1, now(), now()),
(4, 1, now(), now());

insert into task_participants (task_id, participant_id, "createdAt", "updatedAt") VALUES
(1, 1, now(), now()),
(2, 2, now(), now()),
(3, 4, now(), now()),
(4, 8, now(), now());